...
const SAMPLE_DATASETS = [
  { name: 'hr_dataset.csv', path: '/Datasets/hr_dataset.csv', desc: 'HR hiring bias — gender, experience, education', icon: '👤', rows: '19K+', sensitive: ['gender', 'city'], target: 'looking_for_job_change', story: 'Find out why female candidates are massively underrepresented in this HR pipeline' },
  { name: 'loan_dataset.csv', path: '/Datasets/loan_dataset.csv', desc: 'Loan approval bias — caste, gender, income', icon: '🏦', rows: '252K+', sensitive: ['Gender', 'Caste_Category'], target: 'loan_approved', story: 'Discover bias against SC/ST applicants and women in Indian loan approvals' },
  { name: 'medical_dataset.csv', path: '/Datasets/medical_dataset.csv', desc: 'Medical diagnosis bias — age, sex', icon: '🏥', rows: '900+', sensitive: ['sex', 'age'], target: 'heart_disease', story: 'Explore whether heart disease is diagnosed equally across sexes and age groups' },
]
