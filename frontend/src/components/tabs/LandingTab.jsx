...
import { Sparkles, Shield, BarChart3, Wrench, Search, Zap, Code, ShieldCheck } from 'lucide-react'
      ...
      <div className="card-glass fade-in-up" style={{ padding: '60px 40px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center', zIndex: 1, position: 'relative' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', marginBottom: '16px' }}>
            <Shield size={48} color="var(--accent-blue)" strokeWidth={2} />
            <h1 className="float-anim" style={{ 
              fontSize: '4rem', 
              fontWeight: 800, 
              lineHeight: 1.1,
              ...
              <span style={{ color: 'var(--text-primary)' }}>Lens</span>
            </h1>
          </div>
          ...
          <div className="fade-in-up stagger-2" style={{ display: 'flex', gap: '16px', justifyContent: 'center' }}>
            <button 
              ...
              style={{ fontWeight: 600, padding: '16px 32px', fontSize: '1rem' }}
            >
              <Zap size={20} />
              {t("Initialize Scan Workflow")}
            </button>
            <button 
              className="btn btn-secondary btn-lg" 
              onClick={() => onAuth('scanner')}
              style={{ fontWeight: 600, padding: '16px 32px', fontSize: '1rem' }}
            >
              <Code size={20} />
              {t("Try Prompt Scanner")}
            </button>
          </div>
        </div>
      </div>
